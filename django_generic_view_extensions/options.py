...
class field_link_target():
    ...
    Note: Any function accepting a field_link_target as an argument shoudl also accept in
    its place a string, which would be interpretted as the URL of a link to wrap to use.
    This then supports great felxibility in linking with an enum here to requenst predefined
    link targets or a string to nominat a specific one.
    '''
