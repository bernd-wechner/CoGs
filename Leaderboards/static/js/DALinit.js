/* ===================================================================================
	DAL - Django Autocomplete Light, provided s a lovely widget that can be used for
...
function Select2Init(selector, values) {
	...
	if (request.size > 0) {
		...
		// the all parameters disables that pagination. If this ever does not return all of the requested objects we will end
		// up waiting endlessly on them.
		// TODO: We can escape this weakness by implementing the promises better so as not to use wating_for
		//	     The trick is, how?
